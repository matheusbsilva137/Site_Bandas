                ...
                if(isset($_REQUEST["like"]) && $_REQUEST["like"]==true){
                    ...
                    if($rs->execute()){
                        while($registro = $rs->fetch(PDO::FETCH_OBJ)){
                            ...
                            echo "<td>";
                            echo "<a href='alteracao_musica.php?excluir=true&id=" . $registro->cod_banda . "' class='alt'>Alteração</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    }else{
                        echo "Falha na seleção de artistas <br />";
                    }
                    ...
                    if($rs->execute()){
                        while ($registro = $rs->fetch(PDO::FETCH_OBJ)) {
                            ...
                            echo "<td>";
                            echo "<a href='alteracao_banda.php?excluir=true&id=" . $registro->cod_banda . "' class='alt'>Alteração</a>";
                            echo "</td>";
                            echo "</tr>";
                        }
                    }else{
